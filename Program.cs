...
namespace CMP1903M
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // Printing all the key, values generated by the ImportResultSetFromFile method.
            foreach (var item in existingResultSet)
            {
            ...
            // Printing all the key, values generated by the Calculate method.
            foreach (var item in calculateMethod)
            {
                Console.WriteLine(item.Key);
                Console.WriteLine(String.Join(',', item.Value));
            }
